...
export default function ServicesLanding() {
  ...
  const handleCustomServiceNavigate = (card) => {
    if (card.navigationState) {
      navigate(card.navigation, { state: card.navigationState });
      return;
    }
                            ...
                            <td className="px-3 py-2 whitespace-nowrap">
                              <div className="flex items-center gap-1">
                                <button className="px-2 py-1 rounded-md text-[10px] font-semibold bg-red-500/20 text-red-300 hover:bg-red-500 hover:text-white border border-red-500/30 transition-all"
                                  onClick={() => navigate(`/admin/calculator/${id}/${proposalId}`, { state: { servicetype: "paid" } })}>Edit</button>
                        ...
                        {getAdsData.map((order, index) => (
                          <tr key={order.id} className="hover:bg-white/5 transition-colors">
                            ...
                            <td className="px-3 py-2 whitespace-nowrap">
                              <div className="flex items-center gap-1">
                                <button className="px-2 py-1 rounded-md text-[10px] font-semibold bg-red-500/20 text-red-300 hover:bg-red-500 hover:text-white border border-red-500/30 transition-all"
                                  onClick={() => navigate(`/admin/Adscalculator/${id}/${proposalId}`)}>Edit</button>
                        ...
                        {getComplimenatryData.map((order, index) => (
                          <tr key={order.id} className="hover:bg-white/5 transition-colors">
                            ...
                            <td className="px-3 py-2 whitespace-nowrap">
                              <div className="flex items-center gap-1">
                                <button className="px-2 py-1 rounded-md text-[10px] font-semibold bg-red-500/20 text-red-300 hover:bg-red-500 hover:text-white border border-red-500/30 transition-all"
                                  onClick={() => navigate(`/admin/calculator/${id}/${proposalId}`, { state: { servicetype: "complimentary" } })}>Edit</button>
                ...
                <div className="flex-1 flex flex-col py-2 px-1">
                  ...
                  <div className="lg:hidden">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <button
                        onClick={() => navigate(`/admin/calculator/${id}/${proposalId}`, { state: { servicetype: "paid" } })}
